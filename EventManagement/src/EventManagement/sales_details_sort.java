...
import static EventManagement.sales_details.okcancel;
 ...
 * @author DELL
 */
public class sales_details_sort extends javax.swing.JFrame {

    /**
     * Creates new form sales_details_sort
     */
    public sales_details_sort() {
        initComponents();
    ...
    public String s="",e="";
    public sales_details_sort(String start,String end) {
        initComponents();
        jPanel2.setBackground(new Color(0,0,0,80));
        jPanel3.setBackground(new Color(0,0,0,80));
        this.setSize(1435, 760);
        ...
        showBarChart();
        total();
        setPersonTableData();//        showPieChart();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EVENT ID", "USER NAME", "EVENT DATE", "ORG NAME", "TOTEL"
            }
        ));
        ...
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 30, -1, 20));
        ...
        jPanel3.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 40, -1));

        panelBarChart.setLayout(new java.awt.BorderLayout());
        jPanel3.add(panelBarChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 340, 500, 280));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1440, 730));

        setSize(new java.awt.Dimension(1425, 764));
    ...
    private void setPersonTableData(){
        ...
        try{
            ...
            String sql ="SELECT * FROM event_details WHERE event_date BETWEEN '"+s+"' AND '"+e+"' ORDER BY event_date DESC";
            ...
            while(rs.next()){
                ...
                String dc = rs.getString("total");
                String tbData[]={id,un,ed,on,dc};
    ...
    private void total(){
        ...
        try{
            if(s.equals("")||e.equals("")){
                okcancel("Last month can't be taken");
            }
            else{
            PreparedStatement prest;
            String sql ="SELECT sum(total) FROM event_details WHERE event_date BETWEEN '"+s+"' AND '"+e+"' ";
            prest= con.prepareStatement(sql);
            ResultSet rs2 = prest.executeQuery(sql);
            while(rs2.next()){
                dc = rs2.getString("sum(total)");
            }
            gettotal.setText(String.valueOf(dc));
            }
            }catch (SQLException ex) {
            Logger.getLogger(sales_details.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void mbtotal(){
        ...
        try{
            tmtmar=0;
            PreparedStatement prest;
            String sql ="SELECT sum(total) FROM event_details WHERE org_details='MARRIAGE' AND event_date BETWEEN '"+s+"' AND '"+e+"' ";
            prest= con.prepareStatement(sql);
            ResultSet rs = prest.executeQuery(sql);
            while(rs.next()){
                tmtmar = rs.getInt("sum(total)");
            }
            }catch (SQLException ex) {
            Logger.getLogger(sales_details.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void bbtotal(){
         Connection con = myConnection();
        try{
            tbtbar=0;
            PreparedStatement prest1;
            String sql1 ="SELECT sum(total) FROM event_details WHERE org_details='BIRTHDAY' AND event_date BETWEEN '"+s+"' AND '"+e+"' ";
            prest1= con.prepareStatement(sql1);
            ResultSet rs1 = prest1.executeQuery(sql1);
            while(rs1.next()){
                tbtbar = rs1.getInt("sum(total)");
            }
        }catch (SQLException ex) {
            Logger.getLogger(sales_details.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//    }
    ...
    private void date_sortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_date_sortActionPerformed
        ...
        if(((JTextField)start_date.getDateEditor().getUiComponent()).getText().isEmpty()||((JTextField)end_date.getDateEditor().getUiComponent()).getText().isEmpty()){
            ...
            String sd=sdate;
            String ed=edate;
            new sales_details_sort(sd,ed).setVisible(true);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sales_details_sort.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sales_details_sort().setVisible(true);
            }
        });
    }
